...
`;
    await writeFile(
      join(packageDir, ".embark.jsonc"),
      configContent,
    );
    console.log(`  ✓ Created .embark.jsonc for ${packageName} (deploy: ${target})`);
